...
import { Card, Form, InputNumber, Button, Typography, Space, Divider } from 'antd';
          ...
          <Card size="small" style={{ marginBottom: 16, background: '#f0f9ff' }}>
            <Space direction="vertical" style={{ width: '100%' }}>
              ...
              <div>
                ...
                {Math.abs(parseFloat(result.verifyLoss) - parseFloat(result.maxLoss)) < 0.01 && (
                  <Text type="success" style={{ marginLeft: 8 }}>✓ 计算正确</Text>
                )}
              </div>
            </Space>
          </Card>
